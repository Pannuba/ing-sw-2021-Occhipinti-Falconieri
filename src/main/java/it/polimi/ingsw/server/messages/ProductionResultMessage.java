...
public class ProductionResultMessage implements Message
{
	...
	/* This message is always sent after every production action, successful or not. Only when the player chooses to stop the production the rounds will continue */
